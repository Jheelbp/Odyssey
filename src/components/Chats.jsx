...
import { chatlistdata, statusList } from '../data/message_data';
                ...
                >
                    {messages.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <div className={`relative w-[70%] md:w-[40%] p-4 rounded-xl text-white font-semibold ${temp ? 'bg-gradient-to-l from-purple-600 to-purple-400' : 'bg-gradient-to-r from-blue-600 to-blue-400'} shadow-[0_4px_8px_rgba(0,0,0,0.5)]`}>
            ...
            <div className="flex items-center md:p-4 w-full p-2 justify-between">
                <div className="flex items-center md:w-[70%] md:gap-7">
                    ...
                    <input
                        ...
                        className="py-2 px-5 flex-grow rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
                    />
                </div>
